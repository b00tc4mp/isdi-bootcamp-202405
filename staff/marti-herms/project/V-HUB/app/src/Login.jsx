export default function Login() {
    return <main className='flex flex-row w-screen h-screen'>
        ...
        <div className='flex bg-[#1e1e1e] text-white w-2/3 h-full'>
            <form action='' className='flex flex-col m-auto bg-[#616161] w-10/12 h-5/6 justify-center items-center gap-16 rounded-md shadow-md shadow-black'>
                ...
                <input className='w-10/12 h-20 px-3 text-4xl text-black rounded-md border border-solid border-black shadow-md shadow-black' type='password' placeholder='Password' />
                <button className='w-8/12 h-16 text-4xl text-black rounded-md border border-solid border-black bg-rose-500 shadow-md shadow-black' >Login</button>
            </form>
        </div>
    </main>
}