...
export default function Event({ event: currentEvent, onEventDeleted, onEventEdited }) {
    ...
    return (
        <article className='border-b border--b border-gray-500 ml-2 mr-2 mb-[60px]'>
            <Container>
                {currentEvent.image && (
                ...
                {editEventVisible && (
                    <Form className='bg-slate-300 text-slate-900 border rounded-xl' onSubmit={handleEditEventSubmit}>
