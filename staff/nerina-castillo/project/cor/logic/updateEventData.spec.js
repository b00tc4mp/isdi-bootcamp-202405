...
describe('updateEventData', () => {
    ...
    it('succeeds on existing user and event', () => {
        ...
        return User.create({ name: 'gon', username: 'gonzalo', email: 'gon@zalo.com', role: 'user', password: 'gonzalo123' })
            .then(user => {
                userId = user.id
                return Event.create({ author: userId, image: 'https://media.giphy.com/media/gHbQG42yJMVHy/giphy.gif?cid=ecf05e47avd97k5cxmhrnbrgkinaptz3nbevbd8mrtpulz06&ep=v1_gifs_search&rid=giphy.gif&ct=gnlknvliver', description: 'Barrenfields concert', location: { type: 'Point', coordinates: [40.7128, -74.0060] }, startDate: new Date(), endDate: new Date(), startTime: '18:00', title: 'Barrenfields Live' })
            })
            .then(event => {
                eventId = event.id
                return updateEventData(userId, eventId, 'https://media.giphy.com/media/gHbQG42yJMVHy/giphy.gif?cid=ecf05e47avd97k5cxmhrnbrgkinaptz3nbevbd8mrtpulz06&ep=v1_gifs_search&rid=giphy.gif&ct=gnlknvliver', 'Luis Aragofest Title', 'Luis Aragofest', { type: 'Point', coordinates: [41.7128, -75.0060] }, new Date(), '19:00', 'https://crocantickets.com')
            })
    ...
    it('fails on non-existing user', () => {
        ...
        return Event.create({ author: new ObjectId().toString(), description: 'Barrenfields concert', location: { type: 'Point', coordinates: [40.7128, -74.0060] }, startDate: new Date(), endDate: new Date(), startTime: '18:00', title: 'Barrenfields Live' })
            .then(event => {
                return updateEventData(new ObjectId().toString(), event._id.toString(), 'https://media.giphy.com/media/gHbQG42yJMVHy/giphy.gif?cid=ecf05e47avd97k5cxmhrnbrgkinaptz3nbevbd8mrtpulz06&ep=v1_gifs_search&rid=giphy.gif&ct=gnlknvliver', 'Luis Aragofest Title', 'Luis Aragofest', { type: 'Point', coordinates: [41.7128, -75.0060] }, new Date(), '19:00', 'https://crocantickets.com')
            })
    ...
    it('fails on existing user but non-existing event', () => {
        ...
        return User.create({
            ...
            .then(user => {
                return updateEventData(user.id, new ObjectId().toString(), 'https://media.giphy.com/media/gHbQG42yJMVHy/giphy.gif?cid=ecf05e47avd97k5cxmhrnbrgkinaptz3nbevbd8mrtpulz06&ep=v1_gifs_search&rid=giphy.gif&ct=gnlknvliver', 'Luis Aragofest Title', 'Luis Aragofest', { type: 'Point', coordinates: [41.7128, -75.0060] }, new Date(), '19:00', 'https://crocantickets.com')
            })
            .catch(_error => error = _error)
            .finally(() => {
                expect(error).to.be.instanceOf(NotFoundError)
    ...
    it('fails on existing user and event but event does not belong to user', () => {
        ...
        return User.create({
            ...
            .then(user => {
                return Event.create({ author: new ObjectId().toString(), description: 'Barrenfields concert', location: { type: 'Point', coordinates: [40.7128, -74.0060] }, startDate: new Date(), endDate: new Date(), startTime: '18:00', title: 'Barrenfields Live' })
                    .then(event => {
                        return updateEventData(user.id, event.id, 'https://media.giphy.com/media/gHbQG42yJMVHy/giphy.gif?cid=ecf05e47avd97k5cxmhrnbrgkinaptz3nbevbd8mrtpulz06&ep=v1_gifs_search&rid=giphy.gif&ct=gnlknvliver', 'Luis Aragofest Title', 'Luis Aragofest', { type: 'Point', coordinates: [41.7128, -75.0060] }, new Date(), '19:00', 'https://crocantickets.com')
                    })
                    .catch(_error => error = _error)
            })
            .finally(() => {
