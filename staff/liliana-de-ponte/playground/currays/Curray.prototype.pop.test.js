...
console.assert(cars[1].brand === 'lamborghini', 'cars at 1 brand is lamborguini')
console.assert(cars[1].model === 'gto', 'cars at 1 model is model')
console.assert(cars[1].year === '2010', 'cars at 1 year is 2010')

console.assert(car3 === last, 'last is equal to { brand: fiat, model: 500, year: 2017 }')
console.assert(last.brand === 'fiat', 'cars at last brand is fiat')
console.assert(last.model === 'gto', 'cars at last model is 500')
console.assert(last.year === '2017', 'cars at last year is 2017')