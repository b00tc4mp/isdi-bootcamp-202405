...
const cities = new Curray('madrid', 'barcelona', 'leon', 'madrid')
...
console.info('CASE search the word in last index of Array')

const firstWordLastPosition = cities.lastIndexOf('madrid')
console.assert(firstWordLastPosition === 3, 'the last index of madrid is the position 3')

console.info('CASE not found the word in last index of Array')
const wordNotFound = cities.lastIndexOf('navarra')
console.assert(wordNotFound === -1, 'wordNotFound is equal to -1')


console.info('CASE search the word in the last index from the positive position indicated in the Array')
{
    const cities = new Curray('madrid', 'barcelona', 'leon', 'madrid')
    const word = cities.lastIndexOf('madrid', 3)
    console.assert(word === 3, 'the last index of Madrid starting from position 3 is 3')

}
console.info('CASE search the word in the last index from the negative position indicated in the Array')

const word = cities.lastIndexOf('barcelona', -3)
