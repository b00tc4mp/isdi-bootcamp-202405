...
{
    const months = new Curray('Jan', 'Mar', 'Apr', 'Jun')
...
const months = new Curray('Jan', 'Feb', 'Mar', 'Aprr', 'Jun')

const res = months.splice(3, 1, 'Apr')
...
{
    const fruits = new Curray('apple', 'orange', 'lemon', 'banana', 'coco', 'strawberry', 'pinapple', 'peach')

    const removed = fruits.splice(4, 2, 'watermelon')
...
console.info('CASE replace coco and strawberry and pinapple with watermelon')
{
    ...
    const removed = fruits.splice(4, 3, 'watermelon')
...
const fruits = new Curray('apple', 'orange', 'lemon', 'banana', 'coco', 'strawberry', 'pinapple', 'peach', 'acai', 'papaya')
