...
const metalBands = new Curray('iron maiden', 'metallica', 'stratovarius', 'helloween', 'scorpions')
...
const metalBands1 = metalBands.slice(2)
...
const metalBands2 = metalBands.slice(1, 3)
...
const metalBands3 = metalBands.slice(1, -1)
...
const metalBands4 = metalBands.slice(-1,)
