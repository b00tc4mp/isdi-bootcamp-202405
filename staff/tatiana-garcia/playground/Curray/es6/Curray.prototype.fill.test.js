...
console.info('TEST fill numbers with three parameters in Curray')
{
    const nums = new Curray(1, 2, 3, 4);
    const fillNums = nums.fill(0, 1, 4)
...
console.info('TEST fill numbers with two parameters in Curray')
{
    const nums = new Curray(1, 2, 3, 4)
    const fillNums = nums.fill(5, 1)
    console.assert(fillNums.length === nums.length, 'fillNums length is 4')
    console.assert(fillNums[0] === 1, 'fillNums[0] is 1')
...
console.info('TEST fill numbers one parameter in Curray')
{
    const nums = new Curray(1, 2, 3, 4)
    const fillNums = nums.fill(6)
    console.assert(fillNums.length === nums.length, 'fillNums length is 4')
