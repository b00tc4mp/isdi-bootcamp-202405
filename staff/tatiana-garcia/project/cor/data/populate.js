        ...
        return bcrypt.hash('123123123', 8)
            .then(hashedPassword => {
                return User.create([
                    ...
                    { image: 'https://pymstatic.com/99363/conversions/animales-compania-mas-populares-wide_webp.webp', name: 'Marina Garcia', city: 'Zaragoza', description: 'Cuido conejos y cobayas', email: 'marina@gmail.com', linkPage: '', contactEmail: '', phoneNumber: '666666666', password: hashedPassword, role: 'petsitter', pets: ['rabbits', 'guineaPig'] },
                    ...
                    { image: 'https://files.worldwildlife.org/wwfcmsprod/images/Axolotl_WWsummer2021/story_full_width/1vwydt3icc_axolotl_WWsummer2021.jpg', name: 'Carmen Valdivia', city: 'Barcelona', description: 'Solo cuido conejos', email: 'carmen@valdivia.com', linkPage: '', contactEmail: '', phoneNumber: '659367258', password: hashedPassword, role: 'petsitter', pets: ['rabbits'] },
