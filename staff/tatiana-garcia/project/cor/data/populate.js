...
mongoose.connect(process.env.MONGODB_URI)
    ...
    .then(() => {
        return bcrypt.hash('123123123', 8)
            .then(hashedPassword => {
                return User.create([
                    { image: 'https://tse4.mm.bing.net/th?id=OIP.BbK5rb3HPL_ICOjjOrklYgHaDQ&pid=Api&P=0&h=180', name: 'Vetpoint', city: 'Barcelona', description: 'Somos veterinarios pero cuidamos animales', email: 'veterinario@vetpoint.com', linkPage: 'https://www.vetpointclinicaveterinaria.com/es/homepage/', contactEmail: 'info@vetpoint.com', phoneNumber: '936555555', password: hashedPassword, role: 'petsitter', pets: ['rabbits'] },
                    { image: 'https://pymstatic.com/99363/conversions/animales-compania-mas-populares-wide_webp.webp', name: 'Marina Garcia', city: 'Zaragoza', description: 'Cuido rabbits y cobayas', email: 'marina@gmail.com', linkPage: '', contactEmail: '', phoneNumber: '666666666', password: hashedPassword, role: 'petsitter', pets: ['rabbits', 'guineaPig'] },
                    { image: 'https://es.aap.eu/wp-content/uploads/sites/6/2022/10/Petaura_AAP.jpg', name: 'Claudia Fernandez', city: 'Valencia', description: 'Soy una cuidadora de aves que está en Valencia', email: 'claudia@gmail.com', linkPage: 'https://es.aap.eu/mascotismo-de-exoticos/top-7/', contactEmail: 'claudia@gmail.com', phoneNumber: '600221133', password: hashedPassword, role: 'petsitter', pets: ['birds'] },
                    { image: 'https://es.aap.eu/wp-content/uploads/sites/6/2022/10/AAP-Primadomus-Fenec-Rum.jpg', name: 'VetMadrid', city: 'Madrid', description: 'Somos veterinarios pero si necesitas que alguien se quede con tus peques, nosotros nos quedamos con ellos', email: 'vetmadrid@gmail.com', linkPage: 'https://clinicaveterinariamadrid.es/', contactEmail: 'info@vetmadrid.com', phoneNumber: '916555555', password: hashedPassword, role: 'petsitter', pets: ['rabbits', 'guineaPig', 'birds', 'reptiles'] },
                    { image: 'https://arbolabc.nyc3.cdn.digitaloceanspaces.com/Science/animals/articles/animales-exoticos/duck.jpg', name: 'VetGranada', city: 'Granada', description: 'Somos veterinarios pero cuidamos animales', email: 'vetgranada@gmail.com', linkPage: 'https://www.hospitalveterinariosur.com/', contactEmail: 'info@vetgranada.com', phoneNumber: '958555555', password: hashedPassword, role: 'petsitter', pets: ['rabbits', 'reptiles'] },
                    { image: 'https://files.worldwildlife.org/wwfcmsprod/images/Axolotl_WWsummer2021/story_full_width/1vwydt3icc_axolotl_WWsummer2021.jpg', name: 'Carmen Valdivia', city: 'Barcelona', description: 'Solo cuido rabbits', email: 'carmen@valdivia.com', linkPage: '', contactEmail: '', phoneNumber: '659367258', password: hashedPassword, role: 'petsitter', pets: ['rabbits'] },
