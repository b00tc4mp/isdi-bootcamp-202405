console.info('TEST splice in Arrays')

console.info('CASE splice')
...
//se crea la funcion var.splice=function(aquiva el fromindex, el deletecount, elemtn ){ aqui si se haxce todo... el return al final
...
console.assert(months[4] === 'Jun', 'months at 4 is Jun')
    ...
    var removed[i - fromIndex] = this[i]
