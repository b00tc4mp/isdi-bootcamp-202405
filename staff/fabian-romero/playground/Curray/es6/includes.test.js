...
{
    const colors = ('red', 'green', 'blue', 'yellow', 'orange', 'pink', 'skyblue', 'red', 'white', 'black', 'grey')

    // const colors = colors.includes('pink', 2)

    console.assert(colors === true, 'included includes pink')

    const included2 = colors.includes('red', 4)

    console.assert(included2 === true, 'included includes red')


    const included3 = colors.includes('red', 8)

    console.assert(included3 === false, 'included does not include red')
