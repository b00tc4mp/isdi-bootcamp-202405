...
mongoose.connect(process.env.MONGODB_URI)
    .then(() => {
        ...
        // POST /users [req] -> express: (req, res) > cors > "parse json" > "register user handler" -> [res]
        ...
        const getAllPoniesPostsHandler = (req, res) => {
            const { authorization } = req.headers
        ...
        const getAllFavPostsHandler = (req, res) => {
            const { authorization } = req.headers
        ...
        const toggleFavPostHandler = (req, res) => {
            const { authorization } = req.headers
        ...
        const toggleFollowUserHandler = (req, res) => {
            const { authorization } = req.headers
        ...
        const updatePostCaptionHandler = (req, res) => {
            const { authorization } = req.headers
