...
export default function Login({ onLogin, onRegisterClick }) {
    ...
    return <main className="flex flex-col justify-center items-center bg-gradient-to-br from-green-400 to-fuchsia-500 h-screen w-screen">
        <Heading className="fixed top-0 p-10 font-bold text-[60px] z-40">QueerCare</Heading>
        <Image className="h-[20px] w-[20px] fixed top-0 p-10" src=""><svg xmlns="http://www.w3.org/2000/svg" width="100" height="50" viewBox="0 0 300 180">
            ...
            <rect width="300" height="30" y="120" fill="#24408e" />
            <rect width="300" height="30" y="150" fill="#732982" />
        </svg></Image>
