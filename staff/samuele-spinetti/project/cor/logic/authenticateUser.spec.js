...
describe('authenticateUser', () => {
    ...
    it('succeeds on authenticate user', () =>
        bcrypt.hash('123123123', 8)
            ...
            .then(() => authenticateUser('samuspine', '123123123'))
    ...
    it('fails on non-existing user', () => {
        ...
        authenticateUser('samuspine', '123123123')
    ...
    it('fails on wrong password', () => {
        ...
        return bcrypt.hash('123123123', 8)
            .then(hash =>
                User.create({ name: 'Samu', surname: 'Spine', email: 'samu@spine.com', username: 'samuspine', password: hash })
            )
            .then(() => authenticateUser('samuspine', '111111111'))
    ...
    it('fails on password too short', () => {
        ...
        try {
            authenticateUser('samuspine', '123123')
        } catch (_error) {
            error = _error
        } finally {
            expect(error).to.be.instanceOf(ValidationError)
    ...
    it('fails on password with spaces', () => {
        ...
        try {
            authenticateUser('samuspine', '123123 123')
        } catch (_error) {
            error = _error
        } finally {
            expect(error).to.be.instanceOf(ValidationError)
