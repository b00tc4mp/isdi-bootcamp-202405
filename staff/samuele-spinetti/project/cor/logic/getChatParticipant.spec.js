...
describe('getChatParticipant', () => {
    ...
    it('succeeds on existing user', () => {
        ...
        return User.create({ name: 'Liliana', surname: 'Deponte', email: 'liliana@deponte.com', username: 'lili', password: '123123123' })
            .then(user =>
                User.create({ name: 'Samu', surname: 'Spine', email: 'samu@spine.com', username: 'samuspine', password: '123123123', avatar: 'http://avatar.com/123' })
                    .then(targetUser =>
    ...
    it('fails on non-existing chat', () => {
        ...
        return User.create({ name: 'Samuele', surname: 'Spinetti', email: 'samu@spine.com', username: 'samuspine', password: '123123123' })
    ...
    it('fails on permission denied', () => {
        ...
        return User.create({ name: 'Samuele', surname: 'Spinetti', email: 'samu@spine.com', username: 'samuspine', password: '123123123' })
            .then(user =>
                User.create({ name: 'Liliana', surname: 'Deponte', email: 'lili@deponte.com', username: 'lili', password: '123123123' })
                    .then(user2 =>
