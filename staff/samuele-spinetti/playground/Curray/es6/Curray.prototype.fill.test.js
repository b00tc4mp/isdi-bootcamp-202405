...
console.info('CASE first 1 parameters')

{
    const numeros = new Curray(1, 2, 3, 4)

    const num1 = numeros.fill(6);
...
console.info('CASE second 2 parameters')

{
    const numeros = new Curray(1, 2, 3, 4)

    const num2 = numeros.fill(5, 1)
