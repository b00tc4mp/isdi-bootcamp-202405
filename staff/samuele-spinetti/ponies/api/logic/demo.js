...
fs.writeFileSync('./logic/users.json', usersJSON)

const usersJSON2 = fs.readFileSync('./logic/users.json', 'utf8')
...
fs.writeFileSync('./logic/posts.json', postsJSON)

const postsJSON2 = fs.readFileSync('./logic/posts.json', 'utf8')
