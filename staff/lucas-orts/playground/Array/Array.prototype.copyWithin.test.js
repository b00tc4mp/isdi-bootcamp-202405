...
console.info('CASE copyWithin 3 parametres and target> start in array')
...
console.info('CASE copyWithin 2 parametres and target> start in array')
...
console.info('CASE copyWithin 3 parameters and target = 0 in Array')
