(function () {
        ...
        try {
            ...
            posts.forEach(function (post) {
                ...
                if (post.author === getUserUsername()) {
                    ...
                    postDeleteButton.className = 'form__button'
                    ...
                    editButton.className = 'form__button'
                    ...
                    editButton.onclick = function () {
                        ...
                        editCaptionSubmitButton.className = 'form__button'
                        ...
                        editCaptionCancelButton.className = 'form__button'
    ...
    addPostButton.onclick = function () {
        ...
        createPostSection.className = 'section__form'
