    ...
    return <>
        ...
        <Container className="fixed w-screen top-0 bottom-0 h-screen left-0 right-0 flex items-center justify-center z-20">
            <Container className="p-6 border bg-white rounded-lg shadow-lg flex-col items-center justify-center space-y-6">
                <Form onSubmit={handlePhoneSubmit} className="flex-col items-center justify-center space-y-4">
                    <Container className="flex-col items-start w-full">
                        <Label htmlFor="phone-input" className="font-semibold mb-2">Phone</Label>
                        <Input type="text" id="phone-input" name="phone-input" placeholder="phone" className="w-full p-2 border rounded-md" />
                    </Container>
