...
console.log('CASE builds a new instance of Array')

var a = new Array

console.assert(a instanceof Array, 'a is a new array')
console.assert(a instanceof Object, 'a is an Object')

console.log('Case biulds a new Array with values')
...
console.log('Case biulds a new Array with only one numeric argument')
...
console.log('Case biulds a new Array with two values')

var a = new Array(10, 20)

console.assert(a instanceof Array, 'a is an Array')
console.assert(a[0] === 10, 'a at 0 is 10')
console.assert(a[1] === 20, 'a is 1 is 20')
