...
console.log('CASE sifth in Curray')
...
console.assert(animals[4] === 'Elephant', 'animals at 3 is Elephant')
console.assert(animals.length === 5, 'animals length is')

const animals2 = animals.shift()
