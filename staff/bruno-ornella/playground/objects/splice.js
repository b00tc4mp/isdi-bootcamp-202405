...
console.assert(months[1] === 'Feb', 'months at 0 is jan')
console.assert(months[2] === 'Mar', 'months at 0 is jan')
console.assert(months[3] === 'Apr', 'months at 0 is jan')
console.assert(months[4] === 'Jun', 'months at 0 is jan')
